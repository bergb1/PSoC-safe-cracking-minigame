...
/*******************************************************************************
* Function Name: CLOCK_O_LED_Start
********************************************************************************
*
* Summary:
...
void CLOCK_O_LED_Start(void) 
{
    ...
    CLOCK_O_LED_CLKEN |= CLOCK_O_LED_CLKEN_MASK;
	CLOCK_O_LED_CLKSTBY |= CLOCK_O_LED_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: CLOCK_O_LED_Stop
********************************************************************************
*
* Summary:
...
void CLOCK_O_LED_Stop(void) 
{
    ...
    CLOCK_O_LED_CLKEN &= (uint8)(~CLOCK_O_LED_CLKEN_MASK);
	CLOCK_O_LED_CLKSTBY &= (uint8)(~CLOCK_O_LED_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: CLOCK_O_LED_StopBlock
********************************************************************************
*
* Summary:
...
{
    if ((CLOCK_O_LED_CLKEN & CLOCK_O_LED_CLKEN_MASK) != 0u)
    {
        ...
        CLK_DIST_AMASK = CLOCK_O_LED_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = CLOCK_O_LED_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* CLOCK_O_LED__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(CLOCK_O_LED_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(CLOCK_O_LED_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: CLOCK_O_LED_StandbyPower
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: CLOCK_O_LED_SetDividerRegister
********************************************************************************
*
* Summary:
                                ...
                                
{
    ...
    uint8 currSrc = CLOCK_O_LED_GetSourceRegister();
    uint16 oldDivider = CLOCK_O_LED_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = CLOCK_O_LED_CLKEN & CLOCK_O_LED_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((CLOCK_O_LED_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: CLOCK_O_LED_GetDividerRegister
********************************************************************************
*
* Summary:
...
{
    return CY_GET_REG16(CLOCK_O_LED_DIV_PTR);
}


/*******************************************************************************
* Function Name: CLOCK_O_LED_SetModeRegister
********************************************************************************
*
* Summary:
...
{
    CLOCK_O_LED_MOD_SRC |= modeBitMask & (uint8)CLOCK_O_LED_MODE_MASK;
}


/*******************************************************************************
* Function Name: CLOCK_O_LED_ClearModeRegister
********************************************************************************
*
* Summary:
...
{
    CLOCK_O_LED_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(CLOCK_O_LED_MODE_MASK));
}


/*******************************************************************************
* Function Name: CLOCK_O_LED_GetModeRegister
********************************************************************************
*
* Summary:
...
{
    return CLOCK_O_LED_MOD_SRC & (uint8)(CLOCK_O_LED_MODE_MASK);
}


/*******************************************************************************
* Function Name: CLOCK_O_LED_SetSourceRegister
********************************************************************************
*
* Summary:
...
{
    uint16 currDiv = CLOCK_O_LED_GetDividerRegister();
    uint8 oldSrc = CLOCK_O_LED_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        CLOCK_O_LED_MOD_SRC |= CYCLK_SSS;
        CLOCK_O_LED_MOD_SRC =
            (CLOCK_O_LED_MOD_SRC & (uint8)(~CLOCK_O_LED_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: CLOCK_O_LED_GetSourceRegister
********************************************************************************
*
* Summary:
...
{
    return CLOCK_O_LED_MOD_SRC & CLOCK_O_LED_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: CLOCK_O_LED_SetPhaseRegister
********************************************************************************
*
* Summary:
...
{
    CLOCK_O_LED_PHASE = clkPhase & CLOCK_O_LED_PHASE_MASK;
}


/*******************************************************************************
* Function Name: CLOCK_O_LED_GetPhase
********************************************************************************
*
* Summary:
...
{
    return CLOCK_O_LED_PHASE & CLOCK_O_LED_PHASE_MASK;
}
